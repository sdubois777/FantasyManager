        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-surface-2 text-slate-200 border border-border rounded-lg focus:outline-none focus:border-blue-500/50 placeholder-slate-600"
              disabled={loading}
            />
